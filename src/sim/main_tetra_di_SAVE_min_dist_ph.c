...
char out_folder[] =  "/orozco/projects/MontecarloJurgen/data/chromatin/nucl_12_62_linker/alter_lj_a_nucl/200";	//"/usr/people/jwalther/Programs/Chromatin/src_test";	//"/orozco/projects/MontecarloJurgen/data/chromatin/nucl_12_62_linker/7";//"/home/jwalther/Programs/Chromatin/src_test";		//"/usr/people/jwalther/Programs/Chromatin/test_output";   //"/orozco/projects/MontecarloJurgen/data/chromatin/nucl_12_62_linker";   	//"/orozco/projects/MontecarloJurgen/data/chromatin/2000bp_linker/energy_conv3";	//"/orozco/projects/MontecarloJurgen/data/chromatin/diff_ll/diff_gene_size/energy_conv3";		//"/orozco/projects/MontecarloJurgen/data/chromatin/diff_ll/equ_gene_size";    //"/home/jwalther/Programs/Chromatin/src_test";    	//"/scratch/orozco/jwalther/chromatin/200mer/random_seq5/test/test_acc";

char seq_file[] = "rand_seq1_700.dat";							
char stif_file[] = "stif_150mer.dat";
int ins_nucl[] = {5,67,129,191,253,315,377,439,501,563,625,687};
...
int it_en, want_to_save_en, int_en_save;	
double **save_en;
int len_seg, *ind_linker, nucl_ind;

int_en_save = 10000;		// Interval to save energy value
len_bp_nucl = 146;
seq_pcs = 10;
no_helpars = 6;
len_out_line = 100;
...
it_mc = 30000000*it_mcsteps;	// number of MC steps to bring structure to minimum energy before particle inserted
				/* 100000 -> 56mer
				   10000000 -> 1000mer
				   2000000 -> 450mer
				   5000000 -> 750mer
...
rnd_start = 3;			// Use random starting structure (1) or use xconfi as starting structure (2) or step-by-step start (3)
...
init_dbl2d_arr(d_nucl_ph,no_nucl,red_ph);
...
if(incr == 1){acc = (phi+1)*7;	
	...
	nucl_positions(nucl_pos,orient_old,pos_old,center_nucl,ins_nucl,nucl_ind);
	nucl_dist(len_seg+1,nucl_ind,num_fl,len_seg,acc,center_bp,nucl_pos,ins_nucl,pos_old,d_nucl,d_nucl_bp,d_nucl_fl,xyz_float, cut_d_bp_nucl,&m_nucl_bp);
...
printf("\n");*/
	...
	//printf("buf_tot_en %lf\n",buf_tot_en);
		if(iflag==2){	// rejected
				...
				transfer_hel_coord(0,itot_mc,xconf_mc,xconf_buf);
				enertot = buf_enertot;
				if(psi>1){transfer_pos_and_orient(0,len_all,orient_old,pos_old,orient_store,pos_store);}
