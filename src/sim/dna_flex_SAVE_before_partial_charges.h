...
void monte_carlo(int it_mc, int itot, double enertot, double *ener, double **xconft, double **xconf, double sc[6], double **xconf0, double ***stiff, double enex, double dd[6], double boltz, double temp, int iflag, double *endenergy, int metr_on, int *no_mc_move)
{

int i0,i,buf_no_mc_move;
...
void monte_carlo_ind(int it_mc, int itot, double enertot, double *ener, double **xconft, double **xconf, double sc[6], double **xconf0, double ***stiff, double enex, double dd[6], double boltz, double temp, int iflag, double *endenergy, int metr_on, int *get_itt)
{
...
void write_bp_pos_in_table(char **table_bp,int itot, int phi, double **pos_store, char out_folder[])
{
...
sprintf(filename,"%s/output_cart/cart_%.6d.dat",out_folder,phi);
FILE *file_cart;
...
//if(phi==0){k=0;}else{k=13*phi;}
	...
	k=0;
	for(i=0;i<3;i++){sprintf(table_bp[k], "%.3lf %.3lf %.3lf\n",zero,zero,zero);}
	k++;
	for(i=0;i<itot;i++){
			sprintf(table_bp[k], "%.3lf %.3lf %.3lf\n",pos_store[i][0],pos_store[i][1],pos_store[i][2]);		
			k++;
			    }
...
void write_bp_triad_in_table(char **table_bp_triad,int itot, int phi, double ***store_orient_t_i, char out_folder[])
{
